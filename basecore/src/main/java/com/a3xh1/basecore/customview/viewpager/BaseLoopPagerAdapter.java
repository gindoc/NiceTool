...
//    private final ViewPager mViewPager;
    private Reference<ViewPager> mViewPagerReference;
...
//        mViewPager.setOnTouchListener(this);
        mViewPagerReference = new WeakReference<ViewPager>(viewPager);
        mViewPagerReference.get().setOnTouchListener(this);
    }
    ...
    public void notifyDataSetChanged() {
        ...
        if (viewPager!=null && viewPager.getCurrentItem() == 0 && mChildCount != 1) {
...
//        }
    ...
    public final void onPageSelected(int position) {
        if (0 < position && position < mList.size() - 1) {
            ...
            onPageItemSelected(mList.size()-3);     // 图比点多两个
        }
        Timber.e("onPageSelected");
    }
    ...
    public final void onPageScrollStateChanged(int state) {
        ...
        if (state == ViewPager.SCROLL_STATE_IDLE) {
            if (mList.size() > 3) {
                ...
                } else if (viewPager.getCurrentItem() == mList.size() - 1) {
                    viewPager.setCurrentItem(1, false);
                }
            }
            Timber.e("onPageScrollStateChanged");
            ...
            Timber.e("drag pos:%d", viewPager.getCurrentItem());
        } else if (state == ViewPager.SCROLL_STATE_SETTLING) {
            Timber.e("setting pos:%d", viewPager.getCurrentItem());
